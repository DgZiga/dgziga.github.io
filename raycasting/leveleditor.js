...
const PALETTE = {
    ...
    2: {bgColor:"#c49000", textColor:'#ffffff', label:"gravel"}
};
//img/tetures/marioCircuit4_SNES_Better.png
//Level editor
...
//Select img
function showOverlapImg(){
    $("#overlayImg")[0].src=$("#overlapImgIn")[0].value;
    $("#overlayImg").show();
}
